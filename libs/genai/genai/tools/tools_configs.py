...
class SonarConfigurations:
    PATH_METRICS = "/workspaces/gen-ai-tutorials/libs/genai/genai/tools/sonarqube_metrics"
    SONAR_DIR = "/var/tmp/genai/sonarqube"
    SONAR_SCANNER_PATH = "/var/tmp/genai/sonarqube/sonar-scanner-5.0.1.3006-linux"
...
class GitConfigurations:
    REPOS_PATH= "/var/tmp/genai/repos"
    MAX_COMMITS = 100
